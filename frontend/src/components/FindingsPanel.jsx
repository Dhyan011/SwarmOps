  ...
  return (
    ...
    >
      ...
      >
        ...
        <HiOutlineChevronDown
          className={`w-4 h-4 text-slate-300 font-medium transition-transform duration-200 ${
            expanded ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      {expanded && (
        <div className="px-4 pb-4 animate-fade-in">
          <div className="border-t border-white/[0.04] pt-4">
            ...
            {finding.findings && (
              <div className="mb-4">
                <h4 className="text-[11px] font-semibold uppercase tracking-wider text-slate-300 font-medium mb-2">
                  Findings
                </h4>
            ...
            {!finding.findings && finding.status === "running" && (
              <div className="flex items-center gap-2 text-base text-slate-300 font-medium">
            ...
            {!finding.findings && finding.status === "idle" && (
              <p className="text-base text-slate-300">Waiting to start...</p>
            )}
          </div>
        </div>
      )}
...
export default function FindingsPanel({ findings = [] }) {
  ...
  return (
    <div className="space-y-2">
      <h3 className="text-base font-semibold uppercase tracking-wider text-slate-300 font-medium mb-3 px-1">
        Agent Findings
      </h3>
      {findings.length === 0 ? (
        <div className="text-base text-slate-300 py-8 text-center">
