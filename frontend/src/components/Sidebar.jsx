  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[72px] bg-[#0c1220] border-r border-white/[0.08] flex flex-col items-center z-50">
              ...
              className={`
                ...
                ${
                  active
                    ...
                    : "text-slate-300 font-medium hover:text-white hover:bg-white/[0.03]"
                }
              `}
            >
              {active && (
      ...
      <div className="flex flex-col items-center gap-2 pb-5 w-full px-3">
        <button className="w-full max-w-[48px] aspect-square rounded-xl flex items-center justify-center text-slate-300 font-medium hover:text-white hover:bg-white/[0.03] transition-all duration-200 group relative">
