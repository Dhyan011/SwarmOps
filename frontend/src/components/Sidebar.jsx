  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[72px] bg-[#0c1220] border-r border-white/[0.08] flex flex-col items-center z-50">
              ...
              className={`
                ...
                ${
                  active
                    ...
                    : "text-slate-600 font-medium hover:text-black hover:bg-white/[0.03]"
                }
              `}
            >
              {active && (
              ...
              {/* Tooltip */}
              <span className="absolute left-full ml-3 px-2.5 py-1 rounded-md bg-[#1a2340] text-sm font-medium text-black font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150 shadow-lg border border-white/[0.08] z-50">
                {label}
              </span>
            </NavLink>
          );
      ...
      <div className="flex flex-col items-center gap-2 pb-5 w-full px-3">
        <button className="w-full max-w-[48px] aspect-square rounded-xl flex items-center justify-center text-slate-600 font-medium hover:text-black hover:bg-white/[0.03] transition-all duration-200 group relative">
