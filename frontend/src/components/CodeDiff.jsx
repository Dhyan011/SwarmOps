  ...
  if (!patch) {
    return (
      <div className="glass-card-static p-6 text-center">
        <p className="text-base text-slate-700 font-medium">No code diff available</p>
      </div>
    );
  }
  ...
  return (
    <div className="glass-card-static overflow-hidden">
      <div className="px-4 py-3 border-b border-white/[0.08] flex items-center gap-2">
        ...
        <span className="text-base text-slate-700 font-medium ml-2 font-medium">Proposed Fix</span>
      </div>
        ...
        <pre className="text-[13px] leading-6 font-mono p-0 m-0">
          {lines.map((line) => (
            <div
              ...
              `}
            >
              <span className="w-10 text-right pr-4 text-slate-700 select-none shrink-0 text-base leading-6">
                {line.number}
              </span>
              <span
                className={`
