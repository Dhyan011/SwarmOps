        ...
        <div className="p-8 space-y-10">
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-white/5">
              <h3 className="text-base font-bold uppercase tracking-widest text-black font-semibold text-base font-medium mb-6">Multi-Agent Swarm Pipeline</h3>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-8">
            <div className="xl:col-span-3">
              <h3 className="text-base font-bold uppercase tracking-widest text-black font-semibold text-base font-medium mb-4 px-1">Agent Findings</h3>
              <FindingsPanel findings={findings} />
            </div>
            <div className="xl:col-span-2">
              <h3 className="text-base font-bold uppercase tracking-widest text-black font-semibold text-base font-medium mb-4 px-1">Live WebSocket Feed</h3>
            ...
            <motion.div variants={itemVariants} className="mt-12 pt-10 border-t border-white/10 space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-blue-500/5 border border-blue-500/20 rounded-3xl p-8">
                  ...
                  {confidence > 0 && (
                    <div className="pt-6 border-t border-blue-500/10">
                      <span className="text-base font-bold text-black font-semibold text-base font-medium uppercase tracking-widest block mb-3">
                        Confidence Score
                      </span>
                ...
                <div className="lg:col-span-2">
                  <h3 className="text-base font-bold uppercase tracking-widest text-black font-semibold text-base font-medium mb-4 px-1">
                    Proposed Git Patch
                  </h3>
