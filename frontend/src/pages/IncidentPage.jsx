...
export default function IncidentPage() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-950/90 backdrop-blur-3xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden text-white">
        ...
        <div className="border-b border-white/10 bg-white/[0.02] px-8 py-6 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-5">
            <button
              onClick={() => navigate("/")}
              className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-100 text-lg font-semibold hover:text-white hover:bg-white/10 transition-all duration-200"
            >
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-base font-medium text-slate-100 text-lg font-semibold">
                <div className="flex items-center gap-1.5">
                  <HiOutlineServerStack className="w-4 h-4 text-slate-200 text-base font-medium" />
                  {incident?.service || "Unknown Service"}
                </div>
                <div className="flex items-center gap-1.5">
                  <HiOutlineShieldCheck className="w-4 h-4 text-slate-200 text-base font-medium" />
          ...
          <div className="flex items-center gap-3">
             <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-base font-semibold text-slate-300 hover:bg-white/10 hover:text-white transition-all duration-200"
              >
        ...
        <div className="p-8 space-y-10">
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-white/5">
              <h3 className="text-sm font-bold uppercase tracking-widest text-slate-200 text-base font-medium mb-6">Multi-Agent Swarm Pipeline</h3>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-8">
            <div className="xl:col-span-3">
              <h3 className="text-sm font-bold uppercase tracking-widest text-slate-200 text-base font-medium mb-4 px-1">Agent Findings</h3>
              <FindingsPanel findings={findings} />
            </div>
            <div className="xl:col-span-2">
              <h3 className="text-sm font-bold uppercase tracking-widest text-slate-200 text-base font-medium mb-4 px-1">Live WebSocket Feed</h3>
            ...
            <motion.div variants={itemVariants} className="mt-12 pt-10 border-t border-white/10 space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-blue-500/5 border border-blue-500/20 rounded-3xl p-8">
                  ...
                  {confidence > 0 && (
                    <div className="pt-6 border-t border-blue-500/10">
                      <span className="text-sm font-bold text-slate-200 text-base font-medium uppercase tracking-widest block mb-3">
                        Confidence Score
                      </span>
                ...
                <div className="lg:col-span-2">
                  <h3 className="text-sm font-bold uppercase tracking-widest text-slate-200 text-base font-medium mb-4 px-1">
                    Proposed Git Patch
                  </h3>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex items-center justify-between flex-wrap gap-4 mt-8">
                 <div>
                    <h4 className="text-base font-bold text-white mb-1">Investigation Completed</h4>
                    <p className="text-base text-slate-100 text-lg font-semibold">Review the root cause and proposed fix above. Approve to deploy the patch automatically.</p>
                 </div>
                 <div className="flex items-center gap-3">
                  <button 
                    onClick={() => handleAction("reject")}
                    disabled={incident?.status === "deployed" || incident?.status === "rejected"}
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-800 text-white font-bold hover:bg-slate-700 transition-all disabled:opacity-50"
                  >
