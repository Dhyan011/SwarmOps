        ...
        <div className="border-b border-white/10 bg-white/[0.02] px-8 py-6 flex items-center justify-between flex-wrap gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm font-medium text-slate-400">
                <div className="flex items-center gap-1.5">
                  <HiOutlineServerStack className="w-4 h-4 text-slate-500" />
          ...
          <div className="flex items-center gap-3">
             <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm font-semibold text-slate-300 hover:bg-white/10 hover:text-white transition-all duration-200"
              >
        ...
        <div className="p-8 space-y-10">
          ...
          {incident?.description && (
            <motion.div variants={itemVariants} className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6">
               <h3 className="text-xs font-bold uppercase tracking-widest text-red-400 mb-2">Reported Incident</h3>
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-white/5">
              <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-6">Multi-Agent Swarm Pipeline</h3>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-8">
            <div className="xl:col-span-3">
              <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4 px-1">Agent Findings</h3>
              <FindingsPanel findings={findings} />
            </div>
            <div className="xl:col-span-2">
              <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4 px-1">Live WebSocket Feed</h3>
            ...
            <motion.div variants={itemVariants} className="mt-12 pt-10 border-t border-white/10 space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4 px-1">
                    Proposed Git Patch
                  </h3>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex items-center justify-between flex-wrap gap-4 mt-8">
                 <div>
                    ...
                    <p className="text-sm text-slate-400">Review the root cause and proposed fix above. Approve to deploy the patch automatically.</p>
                 </div>
                 <div className="flex items-center gap-3">
                  <button 
